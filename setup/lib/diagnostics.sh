...
# Telemetry disabled in this fork: NANOCLAW_PH_KEY is empty by default,
# so ph_event short-circuits before any network call. Set it in env to
# opt back in.
NANOCLAW_PH_KEY="${NANOCLAW_PH_KEY:-}"
