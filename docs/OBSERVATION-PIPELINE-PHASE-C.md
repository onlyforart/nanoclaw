...
**Branch:** `skill/web-ui` — builds on [Phase A PR 5](OBSERVATION-PIPELINE-PHASE-A.md) web UI surfaces.
...
**List view:**
- Table: source channel, sender, timestamp, raw_text preview (truncated), label status badge (labelled/unlabelled)
- Filters: source channel dropdown, labelled/unlabelled toggle, search text
- Pagination
